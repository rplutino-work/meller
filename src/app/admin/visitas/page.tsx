...
export default function VisitasPage() {
  ...
  async function updateEstado(id: string, estado: string) {
    try {
      await fetch(`/api/solicitudes/${id}`, {
        ...
        body: JSON.stringify({ estado, tipo: 'visita' }),
      })
      fetchSolicitudes()
    } catch (error) {
  ...
  async function deleteSolicitud(id: string) {
    ...
    try {
      await fetch(`/api/solicitudes/${id}?tipo=visita`, {
        method: 'DELETE',
      })
      fetchSolicitudes()
      setModalOpen(false)
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '400px' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '14px' }}>Cargando solicitudes...</p>
        </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      {filteredSolicitudes.length === 0 ? (
        <div style={{
          ...
          <p style={{ color: '#475569', fontWeight: 500, fontSize: '16px', margin: '0 0 8px 0' }}>No se encontraron solicitudes</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '16px' }}>
          {filteredSolicitudes.map((solicitud) => {
            ...
            const EstadoIcon = estadoIcons[solicitud.estado] || Clock
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'start', gap: '8px', fontSize: '13px', color: '#64748b' }}>
                    <MapPin size={14} style={{ marginTop: '2px', flexShrink: 0 }} />
                    <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>
                      {solicitud.direccion}, {solicitud.localidad}
                    </span>
                  </div>
                </div>
          ...
          <div style={{
            ...
            >
              <div style={{
                ...
                <h2 style={{ fontSize: '20px', fontWeight: 600, color: '#1e293b', margin: 0 }}>Detalle de Solicitud</h2>
                <button
                  onClick={() => setModalOpen(false)}
                  style={{
                    padding: '8px',
              ...
              <div style={{ padding: '20px', overflowY: 'auto', flex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{
                    ...
                    <MapPin size={20} style={{ color: '#64748b', marginTop: '2px', flexShrink: 0 }} />
                    <div style={{ flex: 1 }}>
                      <p style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 4px 0' }}>Dirección</p>
                      <p style={{ fontWeight: 500, color: '#1e293b', margin: '0 0 4px 0', fontSize: '14px' }}>{selectedSolicitud.direccion}</p>
                      <p style={{ color: '#64748b', margin: 0, fontSize: '13px' }}>{selectedSolicitud.localidad}</p>
                    </div>
                  </div>
                  ...
                  {selectedSolicitud.mensaje && (
                    <div style={{
                      ...
                      <MessageSquare size={20} style={{ color: '#64748b', marginTop: '2px', flexShrink: 0 }} />
                      <div style={{ flex: 1 }}>
              ...
              <div style={{
                ...
                <a
                  href={`https://wa.me/54${selectedSolicitud.telefono.replace(/\D/g, '')}?text=Hola ${selectedSolicitud.nombre}, te contactamos de MeleRoller...`}
                  target="_blank"
