...
const toldosMenu = [
  { name: 'Toldos y Cerramientos', href: '/toldos-cerramientos', id: 'toldos-cerramientos' },
]

interface ToldosLayoutProps {
  children: ReactNode
  currentPage: string
  titulo: string
  subtitulo: string
...
export default function ToldosLayout({
  children,
  currentPage,
  titulo,
  subtitulo,
  ...
  useEffect(() => {
    setMounted(true)
    // Ocultar el footer global en las páginas de toldos
          ...
          {visitModalOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-20 left-4 right-4 bottom-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-xl md:w-full bg-white shadow-2xl z-[110] overflow-hidden"
