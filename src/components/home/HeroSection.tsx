      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            {/* Contacto - top right - solo desktop */}
            ...
            {/* Menu items - layout desktop/mobile */}
            <div className="header-nav-container lg:hidden" style={{ paddingTop: '40px', paddingBottom: '40px' }}>
              <div style={{ width: '100%' }}>
                {/* Cortinas */}
            ...
            <div className="hidden lg:flex flex-col items-start justify-start" style={{ position: 'absolute', top: '120px', right: '60%', paddingBottom: '30px' }}>
